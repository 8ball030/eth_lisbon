...
"""This package contains payload tests for the PriceProphetAbciApp."""
...
class PayloadTestCase:
    ...
    name: str
    payload_cls: Type[BasePriceProphetPayload]
    content: Hashable
...
def test_payloads(test_case: PayloadTestCase) -> None:
    """Tests for PriceProphetAbciApp payloads"""
